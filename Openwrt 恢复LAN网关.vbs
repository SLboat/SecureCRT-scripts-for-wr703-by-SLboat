...
' 网关设置到192.168.1.1
const work_off = "uci set network.lan.ipaddr=192.168.1.1 && uci commit && /etc/init.d/network restart"
...
Sub Main
		...
		If crt.screen.WaitForString("link dow", 2) <> True Then
			...
			Exit Sub
		End If
		MsgBox "The Lan Gate Way is [192.168.1.1],Now you can set your pc to fit it:)"
End Sub
